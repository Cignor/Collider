...
execute_process(
  COMMAND "C:/Git/cmd/git.exe" --git-dir=.git show-ref "v2.4.1"
  WORKING_DIRECTORY "H:/0000_CODE/01_collider_pyo/juce/build-audio-only/_deps/box2d_fc-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'H:/0000_CODE/01_collider_pyo/juce/build-audio-only/_deps/box2d_fc-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'H:/0000_CODE/01_collider_pyo/juce/build-audio-only/_deps/box2d_fc-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
