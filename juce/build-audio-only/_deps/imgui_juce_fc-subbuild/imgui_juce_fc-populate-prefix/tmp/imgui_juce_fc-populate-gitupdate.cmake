...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'H:/0000_CODE/01_collider_pyo/juce/build-audio-only/_deps/imgui_juce_fc-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'H:/0000_CODE/01_collider_pyo/juce/build-audio-only/_deps/imgui_juce_fc-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
