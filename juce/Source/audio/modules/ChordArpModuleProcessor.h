...
public:
    ...
    // New Degree Range Parameters
    static constexpr auto paramIdDegreeRangeMin = "degreeRangeMin";
    static constexpr auto paramIdDegreeRangeMax = "degreeRangeMax";
    static constexpr auto paramIdDegreeRangeMode = "degreeRangeMode";
    ...
    static constexpr auto paramIdScaleMod = "scale_mod";
    static constexpr auto paramIdKeyMod = "key_mod";
    static constexpr auto paramIdVoicingMod = "voicing_mod";
    static constexpr auto paramIdArpModeMod = "arpMode_mod";
    static constexpr auto paramIdRangeModeMod = "rangeMode_mod";
    static constexpr auto paramIdNumVoicesMod = "numVoices_mod";

    ChordArpModuleProcessor();
    ~ChordArpModuleProcessor() override;
...
private:
    ...
    // New cached pointers
    std::atomic<float>* degreeRangeMinParam{nullptr};
    std::atomic<float>* degreeRangeMaxParam{nullptr};
    std::atomic<float>* degreeRangeModeParam{nullptr};
    ...
    struct VizData
    {
        ...
        std::atomic<int>   activeDegreeRange[7];          // 0 or 1 for each degree
        std::atomic<float> currentDegreeHighlight{-1.0f}; // 0-6 or -1
